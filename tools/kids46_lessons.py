...
L1 = {
    ...
    "screens": [
        ...
        # Карта до первого урока: сначала все острова тусклые и дороги нет,
        # потом оживает первый и зовёт нажать на себя.
        {"t": "road",
         "text": "Смотри, куда нам надо — вон он, Драконий Остров, дальний. "
                 "Только дороги туда нет. Ничего, мы её построим!",
         "tone": "показываем вдаль, потом озадаченно, потом бодро"},
        {"t": "road", "open": True,
         "text": "Начнём с Солнечной Полянки. Нажми на первый остров, "
                 "чтобы начать путешествие!",
         "tone": "зовём за собой, с нетерпением"},
        {"t": "story", "pic": "meadow",
...
L3 = {
    ...
    "screens": [
        ...
        {"t": "fingers", "mode": "swap", "token": True,
         ...
         "text": "Теперь я называю вещь, а ты говоришь про неё целым "
                 "предложением. Сколько слов — столько и пальчиков. "
                 "Сказал — нажми «проверить себя».",
        ...
        {"t": "story", "pic": "egg",
         "text": "Интересно, кто же там внутри? Неужели дракончик? Мы обязательно "
                 "узнаем — в следующем приключении. Я буду тебя ждать!",
...
# Что Искорка говорит на карте. Без этого ребёнок попадал на карту и просто
# видел острова, не понимая, что делать. Порядок жёсткий:
# 0 — открылся второй остров, 1 — открылся третий, 2 — пройдено всё,
# 3 — просто вернулись на карту, впереди незакрытый остров.
MAP_SAY = [
    ("Дорожка готова! Нажми на Облачный Остров — полетели дальше.",
     "радостно, зовём за собой"),
    ("Мостик готов! Нажми на Драконий Остров — там нас ждёт праздник.",
     "торжественно, зовём за собой"),
    ("Ты прошёл всю дорогу до праздника! Можно заглянуть на любой остров ещё раз.",
     "тепло, с гордостью"),
    ("Нажми на остров, чтобы продолжить путешествие.",
     "спокойно, приглашаем"),
]
...
FINALE = ("Ты прошёл всю дорогу до праздника и теперь умеешь рассказывать о себе "
          "по-английски! А кто вылупится из яйца — узнаем в следующем приключении.",
          "торжественно, тепло, с предвкушением")
